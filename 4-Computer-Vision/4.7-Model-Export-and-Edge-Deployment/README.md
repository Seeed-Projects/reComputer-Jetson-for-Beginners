...
> **Note:** Replace `yolo26s.pt` with your own trained model path from [Chapter 4.6](../4.6-Train-and-Deploy-Your-Own-Vision-Model/README.md), or use a pretrained model like `yolo26s.pt`.
...
> **Note:** This script requires `yolo26s.engine` file generated by the export commands above. If you don't have it yet, run the export first.
